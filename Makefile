...
loader:
	...
	g++ -o ${OUT_PATH}loader.os -c -fPIC -D_LINUX -I${ARNOLD_PATH}/include src/shader_loader.cpp
shader1:
	g++ -o ${OUT_PATH}tempShader1.os -c -fPIC -D_LINUX -I${ARNOLD_PATH}/include src/syToons.cpp
shader2:
	g++ -o ${OUT_PATH}tempShader2.os -c -fPIC -D_LINUX -I${ARNOLD_PATH}/include src/syRamp.cpp
shader3:
	g++ -o ${OUT_PATH}tempShader3.os -c -fPIC -D_LINUX -I${ARNOLD_PATH}/include src/syColorCorrect.cpp
