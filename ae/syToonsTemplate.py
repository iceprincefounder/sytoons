...
class AEsyToonsTemplate(alShadersTemplate):
	...
	def setup(self):
		...
		self.addControl("color_major")
		self.addControl("color_shadow")
		self.addControl("color_mask")
		self.addControl("color_extra")
		...
		self.addControl("diffuse_color")
		self.addControl("specular_color")
